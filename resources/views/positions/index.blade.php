...
align-items-center">
            <div>
              ...
              <div class="card-description"> Create and manage employee positions </div>
            </div>
            <a href="{{ route('positions.create') }}" class="btn-add">
              <i class="bi bi-plus-circle-fill"></i> Add Position </a>
          </div>
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody> @forelse($positions as $position) <tr>
                  <td>
                    <div class="d-flex
align-items-center
gap-3">
                  ...
                  <td> @if($position->status) <span class="status-active"> ACTIVE </span> @else <span class="status-inactive"> INACTIVE </span> @endif </td>
                  <td>
                    {{ $position->created_at
...
text-center
py-5
text-secondary"> No positions found. </td>
                </tr> @endforelse </tbody>
            </table>
          </div>
          <div class="mt-3">
